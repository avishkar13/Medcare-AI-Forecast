...
modelsRouter.post("/train", rateLimiter.expensive, authorize("simulation:run"), modelsController.train);
modelsRouter.get("/metrics", rateLimiter.read, authorize("simulation:view"), modelsController.metrics);
