...
import { ExpiryBatch, DistributionCenterExpiry, WastePreventionRecord } from "@/types/expiry";
...
export const mockExpiryBatches: ExpiryBatch[] = [
  {
    ...
    forecastDemand: 2100,
    demandCoverage: 42,
    inventoryValue: 18500,
    riskLevel: "critical",
    wasteProbability: 0.85,
    wasteValue: 10730,
    status: "prioritized",
  },
  {
    ...
    forecastDemand: 3800,
    demandCoverage: 90,
    inventoryValue: 24300,
    riskLevel: "medium",
    wasteProbability: 0.10,
    wasteValue: 2430,
    status: "monitor",
  },
  {
    ...
    forecastDemand: 3200,
    demandCoverage: 47,
    inventoryValue: 31600,
    riskLevel: "high",
    wasteProbability: 0.60,
    wasteValue: 18960,
    status: "transfer",
  },
  {
    ...
    batchNumber: "B-2025-02C",
    location: "Midwest DC",
    quantity: 3500,
    unitCost: 3.20,
    expiryDate: formatDate(62),
    daysRemaining: 62,
    forecastDemand: 3100,
    demandCoverage: 89,
  ...
  },
  {
    ...
    category: "Antibiotics",
    batchNumber: "B-2025-03A",
    location: "West Coast DC",
    quantity: 12000,
    unitCost: 2.10,
    expiryDate: formatDate(75),
    daysRemaining: 75,
    forecastDemand: 8000,
    demandCoverage: 66,
    inventoryValue: 25200,
    riskLevel: "high",
    wasteProbability: 0.35,
    wasteValue: 8820,
    status: "transfer",
  },
  {
    ...
    inventoryValue: 7380,
    riskLevel: "critical",
    wasteProbability: 0.90,
    wasteValue: 6642,
    status: "prioritized",
  }
];

export const mockDCExpiry: DistributionCenterExpiry[] = [
  { location: "West Coast DC", atRiskValue: 48600, criticalBatches: 5 },
  { location: "Northeast DC", atRiskValue: 31200, criticalBatches: 2 },
  { location: "Midwest DC", atRiskValue: 26200, criticalBatches: 2 },
  { location: "South DC", atRiskValue: 22400, criticalBatches: 3 },
];

export const mockWastePrevention: WastePreventionRecord[] = [
  { id: "WPR-1", productName: "Cetirizine", actionTaken: "2,000 units redirected", unitsSaved: 2000, valueSaved: 7400, date: formatDate(-2) },
  { id: "WPR-2", productName: "Lisinopril", actionTaken: "1,500 units prioritized", unitsSaved: 1500, valueSaved: 5800, date: formatDate(-5) },
  { id: "WPR-3", productName: "Omeprazole", actionTaken: "1,200 units transferred", unitsSaved: 1200, valueSaved: 4200, date: formatDate(-7) },
];
