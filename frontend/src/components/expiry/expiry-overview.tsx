    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 mb-6">
      ...
      <Card className="border-border/60 shadow-sm bg-background transition-all hover:shadow-md hover:border-primary/20 group">
        <CardContent className="p-4 flex flex-col justify-between h-full">
          ...
          <div>
            <h3 className="text-3xl font-black text-foreground tracking-tight">$128.4K</h3>
            <p className="text-xs font-semibold text-muted-foreground mt-1">Across 37 batches</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-destructive/20 shadow-sm bg-destructive/5 relative overflow-hidden transition-all hover:shadow-md hover:border-destructive/40">
        ...
        <CardContent className="p-4 flex flex-col justify-between h-full">
          ...
          <div>
            <h3 className="text-3xl font-black text-destructive tracking-tight">8</h3>
            <p className="text-xs font-bold text-destructive/80 mt-1">Expires within 30 days</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-warning/30 shadow-sm bg-warning/5 relative overflow-hidden transition-all hover:shadow-md hover:border-warning/50">
        ...
        <CardContent className="p-4 flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-3">
            <span className="text-[10px] font-bold uppercase tracking-widest text-warning-foreground">Expiring Soon</span>
            <div className="p-1.5 rounded bg-warning/20">
              <Clock className="h-3.5 w-3.5 text-warning-foreground" />
            </div>
          </div>
          <div>
            <h3 className="text-3xl font-black text-warning-foreground tracking-tight">17</h3>
            <p className="text-xs font-bold text-warning-foreground/80 mt-1">Within 60 days</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border/60 shadow-sm bg-background transition-all hover:shadow-md">
        <CardContent className="p-4 flex flex-col justify-between h-full">
          ...
          <div>
            <h3 className="text-3xl font-black text-foreground tracking-tight">42,680</h3>
      ...
      <Card className="border-success/20 shadow-sm bg-success/5 relative overflow-hidden transition-all hover:shadow-md hover:border-success/40">
        ...
        <CardContent className="p-4 flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-3">
            <span className="text-[10px] font-bold uppercase tracking-widest text-success">Preventable Waste</span>
            <div className="p-1.5 rounded bg-success/10">
              <TrendingDown className="h-3.5 w-3.5 text-success" />
            </div>
          </div>
          <div>
            <h3 className="text-3xl font-black text-success tracking-tight">$76.2K</h3>
            <p className="text-xs font-bold text-success/80 mt-1">Based on current demand</p>
          </div>
        </CardContent>
      </Card>
    </div>
