        ...
        <div className="flex-1 flex flex-col lg:flex-row items-center gap-8 mt-2 mb-2">
          ...
          <div className="flex-1 w-full space-y-4">
            <div className="flex justify-between text-xs font-bold">
              <span className="text-success flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-success"/> Forecast Demand (2,100)</span>
              <span className="text-destructive flex items-center gap-1.5">Unused Waste (2,900) <div className="w-2 h-2 rounded-full bg-destructive"/></span>
            </div>
            
            <div className="w-full h-8 rounded-md bg-muted overflow-hidden flex border border-border/50 shadow-inner">
              <div className="h-full bg-success transition-all border-r border-background/20 relative group cursor-pointer" style={{ width: '42%' }}>
                <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors"/>
              </div>
              <div className="h-full bg-destructive transition-all relative group cursor-pointer" style={{ width: '58%' }}>
                <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors"/>
              </div>
            </div>
            
            <div className="flex justify-between items-center text-[11px] font-black uppercase tracking-wider text-muted-foreground mt-2">
              <span className="bg-muted/30 px-2 py-1 rounded">Total Inventory: 5,000 Units</span>
              <span className="text-destructive bg-destructive/10 px-2 py-1 rounded">Expires in 14 Days</span>
            </div>
          </div>
          ...
          <div className="w-full lg:w-72 flex flex-col gap-4">
            <div className="bg-success/5 border border-success/20 p-4 rounded-xl flex justify-between items-center transition-all hover:bg-success/10">
               ...
               <span className="text-2xl font-black text-success">42%</span>
            </div>
            <div className="bg-destructive/5 border border-destructive/20 p-4 rounded-xl flex justify-between items-center transition-all hover:bg-destructive/10">
               ...
               <span className="text-2xl font-black text-destructive">$10.7K</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-xs font-semibold text-foreground">
                <span className="font-black text-destructive">2,900 units</span> are projected to remain unused before expiry.
              </span>
              <span className="text-[10px] text-muted-foreground mt-0.5">Assumes baseline consumption rates without intervention.</span>
            </div>
          </div>
          <div className="flex flex-col text-right">
            <span className="text-[10px] font-bold text-destructive uppercase tracking-wider mb-0.5">Potential Waste</span>
            <span className="text-xl font-black text-destructive">$10.7K</span>
          </div>
        </div>
      </CardContent>
    </Card>
